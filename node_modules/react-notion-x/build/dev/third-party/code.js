...
var ClearIcon = (props) => {
  const _a = props, { className } = _a, rest = __objRest(_a, ["className"]);
  return /* @__PURE__ */ React12.createElement("svg", __spreadProps(__spreadValues({
    className: cs("notion-icon", className)
  }, rest), {
    viewBox: "0 0 30 30"
...
var LoadingIcon = (props) => {
  ...
  return /* @__PURE__ */ React13.createElement("svg", __spreadProps(__spreadValues({
    ...
    viewBox: "0 0 24 24"
  }), /* @__PURE__ */ React13.createElement("defs", null, /* @__PURE__ */ React13.createElement("linearGradient", {
    x1: "28.1542969%",
    y1: "63.7402344%",
    x2: "74.6289062%",
    y2: "17.7832031%",
...
var Search = ({ block, search, title = "Search" }) => {
  ...
  const [isSearchOpen, setIsSearchOpen] = React15.useState(false);
...
var Code = ({ block, defaultLanguage = "typescript", className }) => {
  var _a, _b, _c;
  const [isCopied, setIsCopied] = React22.useState(false);
  ...
  const onClickCopyToClipboard = React22.useCallback(() => {
