...
var CollectionColumnTitle = ({ schema }) => {
  ...
  }, /* @__PURE__ */ React17.createElement(PropertyIcon, {
...
var LazyImage = (_a) => {
  ...
  const zoomRef = React19.useRef(zoom ? zoom.clone() : null);
  ...
  const onLoad = React19.useCallback((e) => {
  ...
  const attachZoom = React19.useCallback((image) => {
    if (zoomRef.current && image) {
      ;
      zoomRef.current.attach(image);
    }
  }, [zoomRef]);
  const attachZoomRef = React19.useMemo(() => zoomable ? attachZoom : void 0, [zoomable, attachZoom]);
  if (previewImage) {
    const aspectRatio = previewImage.originalHeight / previewImage.originalWidth;
    if (components.Image) {
      return /* @__PURE__ */ React19.createElement(components.Image, {
        src,
        alt,
        style,
        className,
    ...
    return /* @__PURE__ */ React19.createElement(LazyImageFull, __spreadProps(__spreadValues({
      src
    }, rest), {
    ...
    return /* @__PURE__ */ React19.createElement("img", __spreadValues({
      className,
      style,
      src,
      alt,
...
var LiteYouTubeEmbed = ({
  ...
  const queryString = React20.useMemo(() => qs(__spreadValues({ autoplay: "1", mute: muteParam }, params)), [muteParam, params]);
  ...
  const [isPreconnected, setIsPreconnected] = React20.useState(false);
  const [iframeInitialized, setIframeInitialized] = React20.useState(defaultPlay);
  const [isIframeLoaded, setIsIframeLoaded] = React20.useState(false);
  const warmConnections = React20.useCallback(() => {
    if (isPreconnected)
      return;
    setIsPreconnected(true);
  }, [isPreconnected]);
  const onLoadIframe = React20.useCallback(() => {
    if (iframeInitialized)
      return;
    setIframeInitialized(true);
  }, [iframeInitialized]);
  const onIframeLoaded = React20.useCallback(() => {
    setIsIframeLoaded(true);
  }, []);
  return /* @__PURE__ */ React20.createElement(React20.Fragment, null, /* @__PURE__ */ React20.createElement("link", {
    rel: "preload",
    href: posterUrl,
    as: "image"
  }), isPreconnected && /* @__PURE__ */ React20.createElement(React20.Fragment, null, /* @__PURE__ */ React20.createElement("link", {
    rel: "preconnect",
    href: ytUrl
  }), /* @__PURE__ */ React20.createElement("link", {
    rel: "preconnect",
    href: "https://www.google.com"
  })), isPreconnected && adLinksPreconnect && /* @__PURE__ */ React20.createElement(React20.Fragment, null, /* @__PURE__ */ React20.createElement("link", {
    rel: "preconnect",
  ...
  }), iframeInitialized && /* @__PURE__ */ React20.createElement("iframe", {
    width: "560",
    height: "315",
    frameBorder: "0",
...
var Asset = ({ block, zoomable = true, children }) => {
  ...
  if (block.type === "tweet") {
    ...
    if (!id)
      return null;
    content = /* @__PURE__ */ React21.createElement("div", {
    ...
    }, /* @__PURE__ */ React21.createElement(components.Tweet, {
      id
    }));
    ...
    if (!isServer) {
      content = /* @__PURE__ */ React21.createElement(components.Pdf, {
        file: source
      });
    }
    ...
    if (block.type === "video" && source && source.indexOf("youtube") < 0 && source.indexOf("youtu.be") < 0 && source.indexOf("vimeo") < 0 && source.indexOf("wistia") < 0 && source.indexOf("loom") < 0 && source.indexOf("videoask") < 0 && source.indexOf("getcloudapp") < 0) {
      ...
      content = /* @__PURE__ */ React21.createElement("video", {
        playsInline: true,
        controls: true,
        preload: "metadata",
        style: assetStyle,
      ...
      if (src) {
        ...
        if (youtubeVideoId) {
          content = /* @__PURE__ */ React21.createElement(LiteYouTubeEmbed, {
            id: youtubeVideoId,
            style: assetStyle,
          ...
          style.paddingBottom = "50%";
          content = /* @__PURE__ */ React21.createElement("iframe", {
            style: assetStyle,
            className: "notion-asset-object-fit",
            src,
            title: "GitHub Gist",
    ...
    content = /* @__PURE__ */ React21.createElement(LazyImage, {
      src,
      alt,
      zoomable,
      height: style.height,
...
var PageIconImpl = ({
  ...
  if (isIconBlock(block)) {
    ...
    if (icon && isUrl(icon)) {
      ...
      isImage = true;
      content = /* @__PURE__ */ React23.createElement(LazyImage, {
        src: url,
        alt: title || "page icon",
      ...
      if (!hideDefaultIcon) {
        isImage = true;
        content = /* @__PURE__ */ React23.createElement(DefaultPageIcon, {
          className: cs(className, "notion-page-icon"),
      ...
      isImage = false;
      content = /* @__PURE__ */ React23.createElement("span", {
        className: cs(className, "notion-page-icon"),
        role: "img",
        "aria-label": icon
      }, icon);
...
var PageIcon = React23.memo(PageIconImpl);
...
var PageTitleImpl = (_a) => {
  ...
  if (block.type === "collection_view_page" || block.type === "collection_view") {
    ...
    return /* @__PURE__ */ React24.createElement("span", __spreadValues({
      className: cs("notion-page-title", className)
    }, rest), /* @__PURE__ */ React24.createElement(PageIcon, {
      block,
      defaultIcon,
...
var PageTitle = React24.memo(PageTitleImpl);
...
var GracefulImage = (props) => {
  if (isBrowser) {
    return /* @__PURE__ */ React25.createElement(Img, __spreadValues({}, props));
  } else {
    return /* @__PURE__ */ React25.createElement("img", __spreadValues({}, props));
  }
};
...
function SvgTypeGitHub(props) {
  return /* @__PURE__ */ React26.createElement("svg", __spreadValues({
    viewBox: "0 0 260 260"
  }, props), /* @__PURE__ */ React26.createElement("g", null, /* @__PURE__ */ React26.createElement("path", {
...
var EOI = ({ block, inline, className }) => {
  ...
  switch (domain) {
    case "github.com":
      externalImage = /* @__PURE__ */ React27.createElement(type_github_default, null);
      if (owner) {
  ...
  }, title), (owner || lastUpdated) && /* @__PURE__ */ React27.createElement("div", {
    className: "notion-external-subtitle"
  }, owner && /* @__PURE__ */ React27.createElement("span", null, owner), owner && lastUpdated && /* @__PURE__ */ React27.createElement("span", null, " \u2022 "), lastUpdated && /* @__PURE__ */ React27.createElement("span", null, "Updated ", lastUpdated))));
};

// src/components/text.tsx
var Text = ({ value, block, linkProps, linkProtocol }) => {
  const { components, recordMap, mapPageUrl, mapImageUrl, rootDomain } = useNotionContext();
  return /* @__PURE__ */ React28.createElement(React28.Fragment, null, value == null ? void 0 : value.map(([text, decorations], index) => {
    if (!decorations) {
      if (text === ",") {
        ...
        return /* @__PURE__ */ React28.createElement(React28.Fragment, {
          key: index
        }, text);
      }
    }
    const formatted = decorations.reduce((element, decorator) => {
      ...
      switch (decorator[0]) {
        ...
        case "\u2023": {
          ...
          switch (linkType) {
            case "u": {
              ...
              return /* @__PURE__ */ React28.createElement(GracefulImage, {
            ...
            default: {
              ...
              return /* @__PURE__ */ React28.createElement(components.PageLink, __spreadProps(__spreadValues({
                className: "notion-link",
                href: mapPageUrl(id)
              }, linkProps), {
                target: "_blank",
        ...
        case "c":
          return /* @__PURE__ */ React28.createElement("code", {
            className: "notion-inline-code"
          }, element);
        case "b":
          return /* @__PURE__ */ React28.createElement("b", null, element);
        case "i":
          return /* @__PURE__ */ React28.createElement("em", null, element);
        case "s":
          return /* @__PURE__ */ React28.createElement("s", null, element);
        case "_":
          return /* @__PURE__ */ React28.createElement("span", {
        ...
        case "a": {
          ...
          if ((v[0] === "/" || v.includes(rootDomain)) && id) {
            ...
            return /* @__PURE__ */ React28.createElement(components.PageLink, __spreadValues({
              className: "notion-link",
              href
            }, linkProps), element);
          } else {
            return /* @__PURE__ */ React28.createElement(components.Link, __spreadValues({
              className: "notion-link",
    ...
    }, /* @__PURE__ */ React28.createElement(React28.Fragment, null, text));
    return /* @__PURE__ */ React28.createElement(React28.Fragment, {
      key: index
    }, formatted);
  }));
...
import { getBlockTitle as getBlockTitle3, getBlockParentPage } from "notion-utils";

// src/icons/clear-icon.tsx
import * as React30 from "react";
var ClearIcon = (props) => {
  const _a = props, { className } = _a, rest = __objRest(_a, ["className"]);
  return /* @__PURE__ */ React30.createElement("svg", __spreadProps(__spreadValues({
    className: cs("notion-icon", className)
  }, rest), {
    viewBox: "0 0 30 30"
...
var LoadingIcon = (props) => {
  const _a = props, { className } = _a, rest = __objRest(_a, ["className"]);
  return /* @__PURE__ */ React31.createElement("svg", __spreadProps(__spreadValues({
    className: cs("notion-icon", className)
  }, rest), {
    viewBox: "0 0 24 24"
  }), /* @__PURE__ */ React31.createElement("defs", null, /* @__PURE__ */ React31.createElement("linearGradient", {
    x1: "28.1542969%",
    y1: "63.7402344%",
    x2: "74.6289062%",
    y2: "17.7832031%",
...
// src/components/search-dialog.tsx
var SearchDialog = class extends React32.Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: false,
    ...
    this._inputRef = React32.createRef();
  }
  componentDidMount() {
  ...
  render() {
    ...
    return /* @__PURE__ */ React32.createElement(NotionContextConsumer, null, (ctx2) => {
      const { components, defaultPageIcon, mapPageUrl } = ctx2;
      return /* @__PURE__ */ React32.createElement(components.Modal, {
        isOpen,
        contentLabel: "Search",
      ...
      }, isLoading ? /* @__PURE__ */ React32.createElement(LoadingIcon, {
        className: "loadingIcon"
      }) : /* @__PURE__ */ React32.createElement(SearchIcon, null)), /* @__PURE__ */ React32.createElement("input", {
        className: "searchInput",
        placeholder: "Search",
        value: query,
        ref: this._inputRef,
        onChange: this._onChangeQuery
      }), query && /* @__PURE__ */ React32.createElement("div", {
        role: "button",
        className: "clearButton",
        onClick: this._onClearQuery
      }, /* @__PURE__ */ React32.createElement(ClearIcon, {
        className: "clearIcon"
      }))), hasQuery && searchResult && /* @__PURE__ */ React32.createElement(React32.Fragment, null, searchResult.results.length ? /* @__PURE__ */ React32.createElement(NotionContextProvider, __spreadProps(__spreadValues({}, ctx2), {
        recordMap: searchResult.recordMap
      }), /* @__PURE__ */ React32.createElement("div", {
        className: "resultsPane"
      }, searchResult.results.map((result) => {
        var _a;
        return /* @__PURE__ */ React32.createElement(components.PageLink, {
          key: result.id,
          className: cs("result", "notion-page-link"),
          href: mapPageUrl(result.page.id, searchResult.recordMap)
        }, /* @__PURE__ */ React32.createElement(PageTitle, {
          block: result.page,
          defaultIcon: defaultPageIcon
        }), ((_a = result.highlight) == null ? void 0 : _a.html) && /* @__PURE__ */ React32.createElement("div", {
          className: "notion-search-result-highlight",
          dangerouslySetInnerHTML: {
            __html: result.highlight.html
          }
        }));
      })), /* @__PURE__ */ React32.createElement("footer", {
        className: "resultsFooter"
      }, /* @__PURE__ */ React32.createElement("div", null, /* @__PURE__ */ React32.createElement("span", {
        className: "resultsCount"
      }, searchResult.total), searchResult.total === 1 ? " result" : " results"))) : /* @__PURE__ */ React32.createElement("div", {
        className: "noResultsPane"
      }, /* @__PURE__ */ React32.createElement("div", {
        className: "noResults"
      }, "No results"), /* @__PURE__ */ React32.createElement("div", {
        className: "noResultsDetail"
      }, "Try different search terms"))), hasQuery && !searchResult && searchError && /* @__PURE__ */ React32.createElement("div", {
        className: "noResultsPane"
      }, /* @__PURE__ */ React32.createElement("div", {
        className: "noResults"
      }, "Search error"))));
...
// src/components/header.tsx
var Header = ({ block }) => {
  return /* @__PURE__ */ React33.createElement("header", {
    className: "notion-header"
  }, /* @__PURE__ */ React33.createElement("div", {
    className: "notion-nav-header"
  }, /* @__PURE__ */ React33.createElement(Breadcrumbs, {
    block
  }), /* @__PURE__ */ React33.createElement(Search, {
    block
  })));
};
var Breadcrumbs = ({ block, rootOnly = false }) => {
  const { recordMap, mapPageUrl, components } = useNotionContext();
  const breadcrumbs = React33.useMemo(() => {
  ...
  return /* @__PURE__ */ React33.createElement("div", {
    ...
    if (breadcrumb.active) {
      componentMap.pageLink = (props) => /* @__PURE__ */ React33.createElement("div", __spreadValues({}, props));
    } else {
      pageLinkProps.href = mapPageUrl(breadcrumb.pageId);
    }
    return /* @__PURE__ */ React33.createElement(React33.Fragment, {
      key: breadcrumb.pageId
    }, /* @__PURE__ */ React33.createElement(componentMap.pageLink, __spreadValues({
      className: cs("breadcrumb", breadcrumb.active && "active")
    }, pageLinkProps), breadcrumb.icon && /* @__PURE__ */ React33.createElement(PageIcon, {
      className: "icon",
...
var Search = ({ block, search, title = "Search" }) => {
  ...
  const onOpenSearch = React33.useCallback(() => {
    setIsSearchOpen(true);
  }, []);
  const onCloseSearch = React33.useCallback(() => {
  ...
  }, /* @__PURE__ */ React33.createElement(SearchIcon, {
    className: "searchIcon"
  }), title && /* @__PURE__ */ React33.createElement("span", {
    className: "title"
  }, title)), isSearchOpen && hasSearch && /* @__PURE__ */ React33.createElement(SearchDialog, {
    isOpen: isSearchOpen,
...
var AssetWrapper = ({ blockId, block }) => {
  ...
  const figure = /* @__PURE__ */ React34.createElement("figure", {
  ...
  }, /* @__PURE__ */ React34.createElement(Asset, {
    block: value,
    zoomable: !isURL
...
var Checkbox = ({ isChecked }) => {
  let content = null;
  if (isChecked) {
    content = /* @__PURE__ */ React36.createElement("div", {
      className: "notion-property-checkbox-checked"
    }, /* @__PURE__ */ React36.createElement(check_default, null));
  } else {
    content = /* @__PURE__ */ React36.createElement("div", {
...
// src/context.tsx
var DefaultLink = (props) => /* @__PURE__ */ React37.createElement("a", __spreadValues({
  target: "_blank",
  rel: "noopener noreferrer"
}, props));
var DefaultLinkMemo = React37.memo(DefaultLink);
var DefaultPageLink = (props) => /* @__PURE__ */ React37.createElement("a", __spreadValues({}, props));
var DefaultPageLinkMemo = React37.memo(DefaultPageLink);
var DefaultEmbed = AssetWrapper;
var DefaultHeader = Header;
var dummyLink = (_a) => {
  var _b = _a, { href, rel, target, title } = _b, rest = __objRest(_b, ["href", "rel", "target", "title"]);
  return /* @__PURE__ */ React37.createElement("span", __spreadValues({}, rest));
};
...
var ctx = React37.createContext(defaultNotionContext);
var NotionContextProvider = (_a) => {
  ...
  const wrappedThemeComponents = React37.useMemo(() => __spreadValues({}, themeComponents), [themeComponents]);
  ...
  const value = React37.useMemo(() => __spreadProps(__spreadValues(__spreadValues({}, defaultNotionContext), rest), {
    rootPageId,
  ...
  return /* @__PURE__ */ React37.createElement(ctx.Provider, {
    value
  }, children);
};
var NotionContextConsumer = ctx.Consumer;
var useNotionContext = () => {
  return React37.useContext(ctx);
};
...
import { getTextContent as getTextContent2, getDateValue } from "notion-utils";
...
var Property = (props) => {
  ...
  if (components.Property) {
    return /* @__PURE__ */ React38.createElement(components.Property, __spreadValues({}, props));
  } else {
    return /* @__PURE__ */ React38.createElement(PropertyImplMemo, __spreadValues({}, props));
  }
};
var PropertyImpl = (props) => {
  ...
  const renderTextValue = React38.useMemo(() => function TextProperty() {
    return /* @__PURE__ */ React38.createElement(Text, {
      value: data,
      block
    });
  }, [block, data]);
  const renderDateValue = React38.useMemo(() => function DateProperty() {
    return /* @__PURE__ */ React38.createElement(Text, {
      value: data,
      block
    });
  }, [block, data]);
  const renderRelationValue = React38.useMemo(() => function RelationProperty() {
    return /* @__PURE__ */ React38.createElement(Text, {
      value: data,
      block
    });
  }, [block, data]);
  const renderFormulaValue = React38.useMemo(() => function FormulaProperty() {
    let content2;
    try {
  ...
  const renderTitleValue = React38.useMemo(() => function FormulaTitle() {
    if (block && linkToTitlePage) {
      return /* @__PURE__ */ React38.createElement(components.PageLink, {
        className: cs("notion-page-link"),
        href: mapPageUrl(block.id)
      }, /* @__PURE__ */ React38.createElement(PageTitle, {
        block
      }));
    } else {
      return /* @__PURE__ */ React38.createElement(Text, {
  ...
  const renderPersonValue = React38.useMemo(() => function PersonProperty() {
    return /* @__PURE__ */ React38.createElement(Text, {
      value: data,
      block
    });
  }, [block, data]);
  const renderFileValue = React38.useMemo(() => function FileProperty() {
    const files = data.filter((v) => v.length === 2).map((f) => f.flat().flat());
    return files.map((file, i) => /* @__PURE__ */ React38.createElement(components.Link, {
      key: i,
      className: "notion-property-file",
      href: mapImageUrl(file[2], block),
      target: "_blank",
      rel: "noreferrer noopener"
    }, /* @__PURE__ */ React38.createElement(GracefulImage, {
      alt: file[0],
      src: mapImageUrl(file[2], block),
      loading: "lazy"
    })));
  }, [block, components, data, mapImageUrl]);
  const renderCheckboxValue = React38.useMemo(() => function CheckboxProperty() {
    const isChecked = data && data[0][0] === "Yes";
    return /* @__PURE__ */ React38.createElement("div", {
      className: "notion-property-checkbox-container"
    }, /* @__PURE__ */ React38.createElement(Checkbox, {
      isChecked,
      blockId: void 0
  ...
  const renderUrlValue = React38.useMemo(() => function UrlProperty() {
  ...
  const renderEmailValue = React38.useMemo(() => function EmailProperty() {
    return /* @__PURE__ */ React38.createElement(Text, {
      value: data,
      linkProtocol: "mailto",
      block
  ...
  const renderPhoneNumberValue = React38.useMemo(() => function PhoneNumberProperty() {
    return /* @__PURE__ */ React38.createElement(Text, {
      value: data,
      linkProtocol: "tel",
      block
  ...
  const renderNumberValue = React38.useMemo(() => function NumberProperty() {
  ...
  const renderCreatedTimeValue = React38.useMemo(() => function CreatedTimeProperty() {
  ...
  const renderLastEditedTimeValue = React38.useMemo(() => function LastEditedTimeProperty() {
  ...
  if (data || schema.type === "checkbox" || schema.type === "title" || schema.type === "formula" || schema.type === "created_by" || schema.type === "last_edited_by" || schema.type === "created_time" || schema.type === "last_edited_time") {
    switch (schema.type) {
      ...
      case "date":
        ...
        break;
      default:
        content = /* @__PURE__ */ React38.createElement(Text, {
          value: data,
          block
        });
        break;
...
var PropertyImplMemo = React38.memo(PropertyImpl);
...
var CollectionGroup = (_a) => {
  ...
  if (hidden)
    return null;
  return /* @__PURE__ */ React46.createElement("details", __spreadValues({
    open: true,
    className: "notion-collection-group"
  }, detailsProps), /* @__PURE__ */ React46.createElement("summary", __spreadValues({
  ...
  }, collectionGroup == null ? void 0 : collectionGroup.total))), /* @__PURE__ */ React46.createElement(CollectionViewComponent, __spreadValues({
    collection,
    collectionGroup
  }, rest)));
};
...
var CollectionViewTable = ({
  ...
  if (isGroupedCollection) {
    ...
    return collectionGroups.map((group, index) => /* @__PURE__ */ React47.createElement(CollectionGroup, __spreadProps(__spreadValues({
      key: index
    }, group), {
      collectionViewComponent: (props) => /* @__PURE__ */ React47.createElement(Table, __spreadProps(__spreadValues({}, props), {
        padding,
        width
      })),
      summaryProps: {
...
function Table({ blockIds = [], collection, collectionView, width, padding }) {
  ...
  const tableStyle = React47.useMemo(() => ({
    width,
    maxWidth: width
  }), [width]);
  const tableViewStyle = React47.useMemo(() => ({
    paddingLeft: padding,
    paddingRight: padding
  }), [padding]);
  let properties = [];
...
var CollectionCard = (_a) => {
  ...
  if ((cover == null ? void 0 : cover.type) === "page_content") {
    ...
    if (schema && data) {
      if (schema.type === "file") {
        ...
        const file = files[0];
        if (file) {
          coverContent = /* @__PURE__ */ React48.createElement("span", {
            className: `notion-property-${schema.type}`
          }, /* @__PURE__ */ React48.createElement(LazyImage, {
            alt: file[0],
            src: mapImageUrl(file[2], block),
            style: {
              objectFit: coverAspect,
  ...
  return /* @__PURE__ */ React48.createElement(NotionContextProvider, __spreadProps(__spreadValues({}, ctx2), {
    components: __spreadProps(__spreadValues({}, ctx2.components), {
      Link: dummyLink,
      PageLink: dummyLink
    })
  }), /* @__PURE__ */ React48.createElement(components.PageLink, __spreadValues({
...
var EmptyIcon = (props) => {
  const _a = props, { className } = _a, rest = __objRest(_a, ["className"]);
  return /* @__PURE__ */ React51.createElement("svg", __spreadProps(__spreadValues({
    className
  }, rest), {
    viewBox: "0 0 14 14",
    width: "14"
...
var CollectionViewBoard = ({
  ...
  if (isGroupedCollection) {
    ...
    return collectionGroups.map((group, index) => /* @__PURE__ */ React52.createElement(CollectionGroup, __spreadProps(__spreadValues({
      key: index
    }, group), {
      summaryProps: {
        style: {
      ...
      collectionViewComponent: (props) => /* @__PURE__ */ React52.createElement(Board, __spreadValues({
        padding
      }, props))
    })));
  }
  return /* @__PURE__ */ React52.createElement(Board, {
    padding,
    collectionView,
    collection,
    collectionData
...
function Board({ collectionView, collectionData, collection, padding }) {
  ...
  const boardStyle = React52.useMemo(() => ({
    paddingLeft: padding
  }), [padding]);
  return /* @__PURE__ */ React52.createElement("div", {
    ...
    }, ((_b2 = group.value) == null ? void 0 : _b2.value) ? /* @__PURE__ */ React52.createElement(Property, {
      schema,
      data: [[(_c = group.value) == null ? void 0 : _c.value]],
      collection
    }) : /* @__PURE__ */ React52.createElement("span", null, /* @__PURE__ */ React52.createElement(EmptyIcon, {
      className: "notion-board-th-empty"
    }), " No Select"), /* @__PURE__ */ React52.createElement("span", {
      className: "notion-board-th-count"
    }, group.total)));
  }))), /* @__PURE__ */ React52.createElement("div", {
    ...
    return /* @__PURE__ */ React52.createElement("div", {
      ...
      if (!block)
        return null;
      return /* @__PURE__ */ React52.createElement(CollectionCard, {
...
var CollectionViewImpl = (props) => {
  ...
  switch (collectionView.type) {
    case "table":
      return /* @__PURE__ */ React53.createElement(CollectionViewTable, __spreadValues({}, props));
    case "gallery":
      return /* @__PURE__ */ React53.createElement(CollectionViewGallery, __spreadValues({}, props));
    case "list":
      return /* @__PURE__ */ React53.createElement(CollectionViewList, __spreadValues({}, props));
    case "board":
      return /* @__PURE__ */ React53.createElement(CollectionViewBoard, __spreadValues({}, props));
    default:
      console.warn("unsupported collection view", collectionView);
      return null;
  }
};
var CollectionView = React53.memo(CollectionViewImpl);

// src/third-party/collection.tsx
var isServer2 = typeof window === "undefined";
var Collection = ({ block, className, ctx: ctx2 }) => {
  const context = React54.useMemo(() => __spreadValues({}, ctx2), [ctx2]);
  if (block.type === "page") {
    if (block.parent_table !== "collection") {
      return null;
    }
    return /* @__PURE__ */ React54.createElement(NotionContextProvider, __spreadValues({}, context), /* @__PURE__ */ React54.createElement("div", {
    ...
    return /* @__PURE__ */ React54.createElement(NotionContextProvider, __spreadValues({}, context), /* @__PURE__ */ React54.createElement(CollectionViewBlock, {
      block,
      className
    }));
  }
...
var CollectionViewBlock = ({ block, className }) => {
  ...
  const onChangeView = React54.useCallback((collectionViewId2) => {
  ...
  const { style, width, padding } = React54.useMemo(() => {
    var _a2;
    const style2 = {};
  ...
  }, /* @__PURE__ */ React54.createElement(PageIcon, {
    block,
    className: "notion-page-title-icon",
...
var CollectionViewDropdownMenu = ({ collectionViewId, collectionView, viewIds, onChangeView }) => {
  ...
  return /* @__PURE__ */ React54.createElement(DropdownMenu.Root, null, /* @__PURE__ */ React54.createElement(DropdownMenu.Trigger, {
    ...
    }, /* @__PURE__ */ React54.createElement(check_default, null)), /* @__PURE__ */ React54.createElement(CollectionViewColumnDesc, {
...
var CollectionViewColumnDesc = (_a) => {
  ...
  return /* @__PURE__ */ React54.createElement("div", __spreadValues({
