...
var wrapNextImage = (NextImage) => {
  return React2.memo(function ReactNotionXNextImage(_a) {
    var _b = _a, {
      src,
      alt,
      width,
    ...
    return /* @__PURE__ */ React2.createElement(NextImage, __spreadValues({
      className,
      src,
      alt,
...
var wrapNextLink = (NextLink) => function ReactNotionXNextLink(_a) {
  ...
  return /* @__PURE__ */ React2.createElement(NextLink, {
    href,
    as,
    passHref,
    prefetch,
    ...
    shallow,
    locale
  }, /* @__PURE__ */ React2.createElement("a", __spreadValues({}, linkProps)));
};
...
var LazyImage = (_a) => {
  ...
  const onLoad = React3.useCallback((e) => {
  ...
  const attachZoom = React3.useCallback((image) => {
  ...
  if (previewImage) {
    ...
    if (components.Image) {
      return /* @__PURE__ */ React3.createElement(components.Image, {
        src,
        alt,
        style,
        className,
    ...
    return /* @__PURE__ */ React3.createElement(LazyImageFull, __spreadProps(__spreadValues({
      src
    }, rest), {
    ...
    return /* @__PURE__ */ React3.createElement("img", __spreadValues({
      className,
      style,
      src,
      alt,
...
var Asset = ({ block, zoomable = true, children }) => {
  ...
  if (block.type === "tweet") {
    ...
    if (!isServer) {
      content = /* @__PURE__ */ React5.createElement(components.Pdf, {
        file: source
      });
    }
    ...
    if (block.type === "video" && source && source.indexOf("youtube") < 0 && source.indexOf("youtu.be") < 0 && source.indexOf("vimeo") < 0 && source.indexOf("wistia") < 0 && source.indexOf("loom") < 0 && source.indexOf("videoask") < 0 && source.indexOf("getcloudapp") < 0) {
      ...
      content = /* @__PURE__ */ React5.createElement("video", {
        playsInline: true,
        controls: true,
        preload: "metadata",
        style: assetStyle,
      ...
      if (src) {
        ...
        if (youtubeVideoId) {
          content = /* @__PURE__ */ React5.createElement(LiteYouTubeEmbed, {
            id: youtubeVideoId,
            style: assetStyle,
...
var GracefulImage = (props) => {
  if (isBrowser) {
    return /* @__PURE__ */ React7.createElement(Img, __spreadValues({}, props));
  } else {
    return /* @__PURE__ */ React7.createElement("img", __spreadValues({}, props));
  }
};
...
var EOI = ({ block, inline, className }) => {
  ...
  switch (domain) {
    case "github.com":
      externalImage = /* @__PURE__ */ React9.createElement(type_github_default, null);
      if (owner) {
      ...
      switch (decorator[0]) {
        ...
        case "\u2023": {
          ...
          switch (linkType) {
            ...
            default: {
              ...
              return /* @__PURE__ */ React10.createElement(components.PageLink, __spreadProps(__spreadValues({
                className: "notion-link",
                href: mapPageUrl(id)
              }, linkProps), {
                target: "_blank",
        ...
        case "a": {
          ...
          if ((v[0] === "/" || v.includes(rootDomain)) && id) {
            ...
            return /* @__PURE__ */ React10.createElement(components.PageLink, __spreadValues({
              className: "notion-link",
              href
            }, linkProps), element);
          } else {
            return /* @__PURE__ */ React10.createElement(components.Link, __spreadValues({
              className: "notion-link",
...
var AssetWrapper = ({ blockId, block }) => {
  ...
  const figure = /* @__PURE__ */ React11.createElement("figure", {
...
import { getBlockTitle as getBlockTitle2, getBlockParentPage } from "notion-utils";
...
var NotionContextProvider = (_a) => {
  ...
  const wrappedThemeComponents = React19.useMemo(() => __spreadValues({}, themeComponents), [themeComponents]);
  ...
  const value = React19.useMemo(() => __spreadProps(__spreadValues(__spreadValues({}, defaultNotionContext), rest), {
    rootPageId,
...
var PageAside = ({
  ...
  const actionSectionScrollSpy = React21.useMemo(() => (0, import_lodash2.default)(() => {
...
var FileIcon = (props) => {
  const _a = props, { className } = _a, rest = __objRest(_a, ["className"]);
  return /* @__PURE__ */ React25.createElement("svg", __spreadProps(__spreadValues({
    className
  }, rest), {
    viewBox: "0 0 30 30"
...
var SyncPointerBlock = ({ block, level }) => {
  ...
  return /* @__PURE__ */ React27.createElement(NotionBlockRenderer, {
...
var Block = (props) => {
  ...
  switch (block.type) {
    ...
    case "sub_sub_header": {
      ...
      const classNameStr = cs(isH1 && "notion-h notion-h1", isH2 && "notion-h notion-h2", isH3 && "notion-h notion-h3", blockColor && `notion-${blockColor}`, indentLevelClass, blockId);
...
var NotionRenderer = (_a) => {
  ...
  const zoom = React29.useMemo(() => typeof window !== "undefined" && mediumZoom({
