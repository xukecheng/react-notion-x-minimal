...
var wrapNextImage = (NextImage) => {
  return React.memo(function ReactNotionXNextImage(_a) {
    var _b = _a, {
      src,
      alt,
      width,
    ...
    return /* @__PURE__ */ React.createElement(NextImage, __spreadValues({
      className,
      src,
      alt,
...
var wrapNextLink = (NextLink) => function ReactNotionXNextLink(_a) {
  ...
  return /* @__PURE__ */ React.createElement(NextLink, {
    ...
    shallow,
    locale
  }, /* @__PURE__ */ React.createElement("a", __spreadValues({}, linkProps)));
};
...
var LazyImage = (_a) => {
  ...
  const zoomRef = React2.useRef(zoom ? zoom.clone() : null);
  ...
  const onLoad = React2.useCallback((e) => {
  ...
  const attachZoom = React2.useCallback((image) => {
    if (zoomRef.current && image) {
      ;
      zoomRef.current.attach(image);
    }
  }, [zoomRef]);
  const attachZoomRef = React2.useMemo(() => zoomable ? attachZoom : void 0, [zoomable, attachZoom]);
  if (previewImage) {
    const aspectRatio = previewImage.originalHeight / previewImage.originalWidth;
    if (components.Image) {
      return /* @__PURE__ */ React2.createElement(components.Image, {
        src,
        alt,
        style,
        className,
    ...
    return /* @__PURE__ */ React2.createElement(LazyImageFull, __spreadProps(__spreadValues({
      src
    }, rest), {
    ...
    return /* @__PURE__ */ React2.createElement("img", __spreadValues({
      className,
      style,
      src,
      alt,
...
var LiteYouTubeEmbed = ({
  ...
  const queryString = React3.useMemo(() => qs(__spreadValues({ autoplay: "1", mute: muteParam }, params)), [muteParam, params]);
  ...
  const [isPreconnected, setIsPreconnected] = React3.useState(false);
  const [iframeInitialized, setIframeInitialized] = React3.useState(defaultPlay);
  const [isIframeLoaded, setIsIframeLoaded] = React3.useState(false);
  const warmConnections = React3.useCallback(() => {
    if (isPreconnected)
      return;
    setIsPreconnected(true);
  }, [isPreconnected]);
  const onLoadIframe = React3.useCallback(() => {
    if (iframeInitialized)
      return;
    setIframeInitialized(true);
  }, [iframeInitialized]);
  const onIframeLoaded = React3.useCallback(() => {
  ...
  return /* @__PURE__ */ React3.createElement(React3.Fragment, null, /* @__PURE__ */ React3.createElement("link", {
    ...
    href: posterUrl,
    as: "image"
  }), isPreconnected && /* @__PURE__ */ React3.createElement(React3.Fragment, null, /* @__PURE__ */ React3.createElement("link", {
    rel: "preconnect",
    href: ytUrl
  }), /* @__PURE__ */ React3.createElement("link", {
    rel: "preconnect",
    href: "https://www.google.com"
  })), isPreconnected && adLinksPreconnect && /* @__PURE__ */ React3.createElement(React3.Fragment, null, /* @__PURE__ */ React3.createElement("link", {
    rel: "preconnect",
  ...
  }), iframeInitialized && /* @__PURE__ */ React3.createElement("iframe", {
    width: "560",
    height: "315",
    frameBorder: "0",
...
var Asset = ({ block, zoomable = true, children }) => {
  ...
  if (block.type === "tweet") {
    ...
    if (!id)
      return null;
    content = /* @__PURE__ */ React4.createElement("div", {
    ...
    }, /* @__PURE__ */ React4.createElement(components.Tweet, {
      id
    }));
    ...
    if (!isServer) {
      content = /* @__PURE__ */ React4.createElement(components.Pdf, {
        file: source
      });
    }
    ...
    if (block.type === "video" && source && source.indexOf("youtube") < 0 && source.indexOf("youtu.be") < 0 && source.indexOf("vimeo") < 0 && source.indexOf("wistia") < 0 && source.indexOf("loom") < 0 && source.indexOf("videoask") < 0 && source.indexOf("getcloudapp") < 0) {
      ...
      content = /* @__PURE__ */ React4.createElement("video", {
        playsInline: true,
        controls: true,
        preload: "metadata",
        style: assetStyle,
      ...
      if (src) {
        ...
        if (youtubeVideoId) {
          content = /* @__PURE__ */ React4.createElement(LiteYouTubeEmbed, {
            id: youtubeVideoId,
            style: assetStyle,
          ...
          style.paddingBottom = "50%";
          content = /* @__PURE__ */ React4.createElement("iframe", {
            style: assetStyle,
            className: "notion-asset-object-fit",
            src,
            title: "GitHub Gist",
    ...
    content = /* @__PURE__ */ React4.createElement(LazyImage, {
      src,
      alt,
      zoomable,
      height: style.height,
...
var Text = ({ value, block, linkProps, linkProtocol }) => {
  ...
  return /* @__PURE__ */ React11.createElement(React11.Fragment, null, value == null ? void 0 : value.map(([text, decorations], index) => {
    if (!decorations) {
      if (text === ",") {
    ...
    const formatted = decorations.reduce((element, decorator) => {
      ...
      switch (decorator[0]) {
        ...
        case "\u2023": {
          ...
          switch (linkType) {
            case "u": {
              ...
              return /* @__PURE__ */ React11.createElement(GracefulImage, {
            ...
            default: {
              ...
              return /* @__PURE__ */ React11.createElement(components.PageLink, __spreadProps(__spreadValues({
                className: "notion-link",
                href: mapPageUrl(id)
              }, linkProps), {
                target: "_blank",
        ...
        case "c":
          return /* @__PURE__ */ React11.createElement("code", {
            className: "notion-inline-code"
          }, element);
        case "b":
          return /* @__PURE__ */ React11.createElement("b", null, element);
        case "i":
          return /* @__PURE__ */ React11.createElement("em", null, element);
        case "s":
          return /* @__PURE__ */ React11.createElement("s", null, element);
        case "_":
          return /* @__PURE__ */ React11.createElement("span", {
            className: "notion-inline-underscore"
          }, element);
        case "e":
          return /* @__PURE__ */ React11.createElement(components.Equation, {
            math: decorator[1],
            inline: true
          });
        case "m":
        ...
        case "a": {
          ...
          if ((v[0] === "/" || v.includes(rootDomain)) && id) {
            ...
            return /* @__PURE__ */ React11.createElement(components.PageLink, __spreadValues({
              className: "notion-link",
              href
            }, linkProps), element);
          } else {
            return /* @__PURE__ */ React11.createElement(components.Link, __spreadValues({
              className: "notion-link",
        ...
        case "eoi": {
          ...
          return /* @__PURE__ */ React11.createElement(EOI, {
    ...
    }, /* @__PURE__ */ React11.createElement(React11.Fragment, null, text));
    return /* @__PURE__ */ React11.createElement(React11.Fragment, {
      key: index
    }, formatted);
  }));
...
var ClearIcon = (props) => {
  const _a = props, { className } = _a, rest = __objRest(_a, ["className"]);
  return /* @__PURE__ */ React13.createElement("svg", __spreadProps(__spreadValues({
    className: cs("notion-icon", className)
  }, rest), {
    viewBox: "0 0 30 30"
...
var LoadingIcon = (props) => {
  const _a = props, { className } = _a, rest = __objRest(_a, ["className"]);
  return /* @__PURE__ */ React14.createElement("svg", __spreadProps(__spreadValues({
    className: cs("notion-icon", className)
  }, rest), {
    viewBox: "0 0 24 24"
  ...
  render() {
    ...
    return /* @__PURE__ */ React15.createElement(NotionContextConsumer, null, (ctx2) => {
      ...
      return /* @__PURE__ */ React15.createElement(components.Modal, {
        ...
        className: "clearIcon"
      }))), hasQuery && searchResult && /* @__PURE__ */ React15.createElement(React15.Fragment, null, searchResult.results.length ? /* @__PURE__ */ React15.createElement(NotionContextProvider, __spreadProps(__spreadValues({}, ctx2), {
...
var Breadcrumbs = ({ block, rootOnly = false }) => {
  ...
  return /* @__PURE__ */ React16.createElement("div", {
    ...
    if (breadcrumb.active) {
      componentMap.pageLink = (props) => /* @__PURE__ */ React16.createElement("div", __spreadValues({}, props));
    } else {
      pageLinkProps.href = mapPageUrl(breadcrumb.pageId);
    }
    return /* @__PURE__ */ React16.createElement(React16.Fragment, {
      key: breadcrumb.pageId
    }, /* @__PURE__ */ React16.createElement(componentMap.pageLink, __spreadValues({
...
var Search = ({ block, search, title = "Search" }) => {
  ...
  const [isSearchOpen, setIsSearchOpen] = React16.useState(false);
...
var AssetWrapper = ({ blockId, block }) => {
  ...
  const figure = /* @__PURE__ */ React17.createElement("figure", {
  ...
  if (isURL) {
    ...
    return /* @__PURE__ */ React17.createElement(components.PageLink, {
      style: urlStyle,
...
var Checkbox = ({ isChecked }) => {
  ...
  if (isChecked) {
    ...
    }, /* @__PURE__ */ React19.createElement(check_default, null));
  } else {
    content = /* @__PURE__ */ React19.createElement("div", {
...
var NotionContextProvider = (_a) => {
  ...
  const wrappedThemeComponents = React20.useMemo(() => __spreadValues({}, themeComponents), [themeComponents]);
  ...
  const value = React20.useMemo(() => __spreadProps(__spreadValues(__spreadValues({}, defaultNotionContext), rest), {
    rootPageId,
